...
* [Event Farm Core Platform](https://eventfarm.com)
    * I'm one of the primary authors of the Event Farm Core platform web application front-end, which is built upon Angular (v2+), webpack, typescript, RxJS and NgRX Store. Event Farm is a paid service however demo accounts and limited free accounts are available
