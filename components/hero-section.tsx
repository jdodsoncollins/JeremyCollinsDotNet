...
const HERO_ART = [
  ...
  { era: "modern", still: "/hero/hero-modern-d.svg?v=hands3", live: "/hero/hero-modern-d-live.png?v=kneel0906", cat: "/hero/hero-modern-d-cat.svg?v=full2", catLive: "/hero/hero-modern-d-cat-live.png?v=full2", catFrames: 4, width: 600, height: 560 },
] as const;
