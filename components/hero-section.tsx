      ...
      <div className="max-w-4xl mx-auto px-6 py-20 w-full">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-8">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 bg-neon-green text-background font-display font-bold text-xs tracking-[0.2em] uppercase rounded-lg hover:bg-neon-cyan transition-colors"
          >
            View Projects
        ...
        <div className="flex flex-wrap items-center gap-3 mb-16">
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-neon-green/30 text-neon-green font-mono text-xs tracking-[0.15em] uppercase rounded-lg hover:border-neon-green hover:bg-neon-green/5 transition-all"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-neon-cyan/30 text-neon-cyan font-mono text-xs tracking-[0.15em] uppercase rounded-lg hover:border-neon-cyan hover:bg-neon-cyan/5 transition-all"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 border border-neon-magenta/30 text-neon-magenta font-mono text-xs tracking-[0.15em] uppercase rounded-lg hover:border-neon-magenta hover:bg-neon-magenta/5 transition-all"
          >
            <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
