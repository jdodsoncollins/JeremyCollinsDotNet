...
const HERO_ART = [
  ...
  { era: "1990s", still: "/hero/hero-1990s.svg?v=bit16", live: "/hero/hero-1990s-live.png?v=era1", cat: "/hero/hero-1990s-cat.svg?v=bit16", catLive: "/hero/hero-1990s-cat-live.png?v=swish2", catFrames: 4, width: 320, height: 280 },
  { era: "modern", still: "/hero/hero-modern-d.svg?v=hands3", live: "/hero/hero-modern-d-live.png?v=kneel0906", cat: "/hero/hero-modern-d-cat.svg?v=cut2", catLive: "/hero/hero-modern-d-cat-live.png?v=swish2", catFrames: 6, width: 600, height: 560 },
] as const;
