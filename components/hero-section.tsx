...
const HERO_ART = [
  ...
  { era: "modern", still: "/hero/hero-modern-sit.svg?v=sit1", live: "/hero/hero-modern-sit-live.png?v=sit1", cat: "/hero/hero-modern-sit-cat.svg?v=sit1", width: 431, height: 420 },
] as const;
