        ...
        <article className="border border-border/60 bg-card/20 backdrop-blur-sm">
          ...
          <div className="p-6 md:p-8 border-b border-border/40">
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-5 py-2.5 border border-neon-green text-neon-green font-mono text-xs tracking-[0.15em] uppercase rounded-lg hover:bg-neon-green/10 transition-all neon-btn-glow-green"
            >
