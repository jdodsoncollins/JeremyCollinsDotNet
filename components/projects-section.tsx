          ...
          <div className="p-6 md:p-8 border-b border-border/40">
            <div className="flex items-start gap-5 mb-6">
              ...
              <div>
                ...
                <p className="font-mono text-xs text-neon-green mt-1 tracking-wide">
                  iOS App &mdash; Safari Web Developer Tools
                </p>
              </div>
            </div>
            ...
            {/* Feature list */}
            <div className="mb-8">
              <p className="font-mono text-xs text-neon-cyan tracking-[0.2em] mb-3">
                {">"} FEATURES:
              </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 px-5 py-2.5 border border-neon-green text-neon-green font-mono text-xs tracking-[0.15em] uppercase hover:bg-neon-green/10 transition-all"
            >
      ...
      {expandedImage && (
        ...
        >
          <div className="relative max-w-xs w-full" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setExpandedImage(null)}
              className="absolute -top-10 right-0 font-mono text-xs text-muted-foreground hover:text-neon-green transition-colors tracking-wider"
            >
              [ESC] CLOSE
            </button>
            <div className="border border-neon-cyan/40 overflow-hidden box-glow">
              <Image
                src={expandedImage}
