...
The **"tl;dr"** of this page is that I'm a full-stack software developer, but I've gravitated toward front-end web. I'm product-focused, down-to-earth, I want to take things from 0-to-1. I enjoy working in industries where I can apply general domain knowledge. If given the choice between *interesting company* or *interesting tech stack*, I'd choose the interesting company every time. Modern tech stacks are great (especially modern frontend tooling) but working with product and design to create solutions using the tooling available is when I feel the most engaged.

### Some of my Previous Full-Time Work
* [MasterClass](https://masterclass.com)
    * MasterClass is an online learning video platform. As a member of the Growth Engineering team, I worked on deploying and managing A/B test experiemnts, and transitoned React pages served by Ruby to a NextJS frontend with Rails API.
