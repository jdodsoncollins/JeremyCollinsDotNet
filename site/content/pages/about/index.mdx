...
* [MasterClass](https://masterclass.com)
    * MasterClass is an online learning video platform, but probably the most well-known one amongst the whole category of ed services like this. I'm a member of the Growth Engineering team, currently working on a transiton from React pages served by Ruby to a NextJS frontend with Rails API.
...
* [Plink API, Consumer, and Business Portal](https://plink.ai)
...
* [Act-On](https://act-on.com)
    * Act-On is a marketing automation platform, allowing the client to track the lead-gen funnel and launch targeted marketing based on lead behavior, and is designed to complement existing CRM solutions already in place by the client. As part of this team, I migrated from a customer support role, to a more "white-glove" developer support role, and finally to the developer team for the landing page and email builder tool.
