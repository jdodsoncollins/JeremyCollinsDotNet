...
The **"tl;dr"** of this page is that I'm a full-stack software developer, but I've gravitated toward front-end web. I'm product-focused, down-to-earth, I want to take things from 0-to-1. I enjoy working in industries where I can apply general domain knowledge. If given the choice between *boring tech stack and interesting company* or *boring company and interesting tech stack*, I'd choose the interesting company every time. Working with product and design to create solutions using the tooling available is when I feel the most engaged.
