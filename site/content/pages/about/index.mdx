...
This site is built with [Gatsby](https://www.gatsbyjs.org/), and hosted on a Digital Ocean Ubuntu droplet. I use only very light, privacy-respecting analytics from [Fathom](https://usefathom.com), self hosted on this domain.
