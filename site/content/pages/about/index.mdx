...
I like the web. I view it as essential to have an open platform for applications, agnostic of a particular ecosystem, and with open standards to make the code portable between platforms. I've participated in [Open Web Advocacy](https://open-web-advocacy.org/). 
