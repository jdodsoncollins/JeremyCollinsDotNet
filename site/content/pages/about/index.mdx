...
I love the web. Apple products are great (my Macbook and iPhone are amazing) but I view it as essential to have an open platform for applications, agnostic of a particular ecosystem, and with open standards to make the code portable between platforms. I've participated in [Open Web Advocacy](https://open-web-advocacy.org/). And the web is great outside your browser window as well -- tools such as Electron are *awesome* because they allow applications to exist that otherwise wouldn't exist on MacOS/Windows at all, and React Native is just really cool (and important to have as an option) in general.
