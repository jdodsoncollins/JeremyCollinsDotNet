---
title: Using Raspberry Pi as a NAS macOS Time Machine (2020 edition)
date: 2020-04-21
tags:
  - macOS
  - linux
...
I've now had a few days of reliable, consistent automated Time Machine backups accomplished via my Mac and Rapberry Pi 4B now, attached to a spare 1TB 2.5" USB 3.0 drive. This has persisted across multiple reboots of both the Pi and Mac, so I think it's solid enough to write down for the world.
...
Disclaimer: This works on my Mac, running macOS 10.15.4 (Catalina) and Pi 4B running the most up to date default Rapbian OS. This is as of April 2020.
...
* However ext4 means you cannot plug this drive directly into a mac and must do a network restore if using it to restore your mac. If you don't have a gigabit home network, USB 3 drive, and Raspberry Pi 4B (with USB 3), you probably want to just skip this guide.
