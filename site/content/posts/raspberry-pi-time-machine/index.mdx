...
*Update November 2020:* This appears to still work on macOS Big Sur (release candidate), using the latest Raspbian
...
- Next, we want to auto-mount it to a designated folder, so run `sudo nano /etc/fstab`
    ...
    - Add this line to the bottom of the file: `UUID=8c9d728a-54f3-4948-81ea-f0482c89fc73 /mnt/usbtimemachine ext4   force,nofail,rw,noauto   0   0`
