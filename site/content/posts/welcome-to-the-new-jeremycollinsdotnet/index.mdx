...
This site is now built with [Gatsby](https://www.gatsbyjs.org/), and extends the theme [Minimal Blog by LekoArts](https://github.com/LekoArts/gatsby-themes/tree/master/themes/gatsby-theme-minimal-blog). It also is a *progressive web app*, becuase Gatsby makes it easy to do so and it is cool tech (though I realize it is complete unnecessary on a small site like this).
